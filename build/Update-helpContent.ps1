...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "Celerium.ITGlue\docs"
        NO  - "Celerium.ITGlue\Celerium.ITGlue\docs"

    Example: "C:\Celerium\Projects\Celerium.ITGlue\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "Celerium.ITGlue\docs"
    Reference:
        Yes - "Celerium.ITGlue\docs\Endpoints.csv"
        NO  - "Celerium.ITGlue\Celerium.ITGlue\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\Celerium.ITGlue\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/Celerium.ITGlue"
