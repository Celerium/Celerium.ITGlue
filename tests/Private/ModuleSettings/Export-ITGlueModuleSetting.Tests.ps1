<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-ITGlueModuleSettings.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-ITGlueModuleSettings.Tests.ps1 -Output Detailed
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "Should export successfully" {
            ...
            Export-ITGlueModuleSettings -ITGlueConfigPath $exportPath -ErrorVariable moduleSettingsError -WarningAction SilentlyContinue
        ...
        It "Configuration file should contain required values" {
            ...
            $configFile = Import-LocalizedData -BaseDirectory $exportPath -FileName "config.psd1"
                ...
                $configFile.ITGlueModuleBaseURI                 | Should -Not -BeNullOrEmpty
                $configFile.ITGlueModuleApiKey                  | Should -Not -BeNullOrEmpty
                $configFile.ITGlueModuleJSONConversionDepth    | Should -Not -BeNullOrEmpty
        }
