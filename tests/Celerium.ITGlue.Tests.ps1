...
.NOTES
    ...
    NAME: Celerium.ITGlue.Tests.ps1
    Type: PowerShell
...
.SYNOPSIS
    Pester tests for the Celerium.ITGlue module manifest file
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'Celerium.ITGlue.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'ce707f0f-1969-4192-a08b-80f62be28f2f'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Celerium.ITGlue/blob/master/LICENSE'
        }
        ...
        It "Manifest [ PowerShellVersion ] has valid data" {
            $Module.PowerShellVersion | Should -BeGreaterOrEqual '5.1'
        }

        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget) {
                'built'     { ($Module.NestedModules.Name).Count | Should -Be 0 }
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 115 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 116
        }
        ...
        It "Manifest [ Tags ] has valid data" {
            ...
            ($Module.PrivateData.PSData.Tags).Count | Should -BeGreaterOrEqual 10
        }

        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Celerium.ITGlue/blob/master/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Celerium.ITGlue'
        }
        ...
        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Celerium.ITGlue/blob/master/README.md'
        }
